#!/usr/bin/env python3
"""
Live progress monitor for chunk 2021 fetch - optimized for VS Code terminal
...
def parse_latest_progress(log_path: Path) -> dict:
    ...
    for line in reversed(lines):
        if "Day " in line and "/" in line and "ETA:" in line:
            try:
                # Parse: [  6%] Day 12/260 20210104 | 777 syms | 5.1 d/hr | ETA: 33.9h
                parts = line.split()
...
def main():
    print("=" * 70)
    print("📊 IBKR Chunk 2021 Fetch - Live Monitor")
    print("=" * 70)
